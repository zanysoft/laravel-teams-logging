...
namespace ZanySoft\LaravelTeamsLogging\Exception;
...
class FlattenException
{
    ...
    {
        $this->class = strpos($class, "@anonymous\0") !== false ? (get_parent_class($class) ?: key(class_implements($class)) ?: 'class').'@anonymous' : $class;
